...
#define C_UMAP                ((uint16_t) 0x6084)		//	'mu'
#define C_STAR                ((uint16_t) 0xA0DD)		//	'*'
#define C_MINUS               ((uint16_t) 0xA000)		//	'-'
#define C_PLUS                ((uint16_t) 0xA014)		//	'+'
#define C_SLATCH              ((uint16_t) 0x00c0)		//	'/'
#define C_PERCENT_1           ((uint16_t) 0xec00)		//	degree / percent circle
#define C_PERCENT_2           ((uint16_t) 0xb300)		//  bottom percent circle
#define C_FULL                ((uint16_t) 0xffdd)		//	all
